...
var baozhangTool = {
  setYingyinzhangshu: function setYingyinzhangshu(value) {
  ...
  setYusuanriqi: function setYusuanriqi(value) {
    $("#claimDate").val(value).trigger('input').trigger('blur');
  },
  setZhaiyao: function setZhaiyao(value) {
    $("#summaryDesc").val(value).trigger('input').trigger('blur');
  },
  setBeizhu: function setBeizhu(value) {
